    ...
    <main className='min-h-screen bg-slate-50 text-slate-900'>
      ...
      <article className='mx-auto max-w-4xl px-6 py-16 sm:py-20'>
        <div className='rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-12'>
          ...
          <section className='mt-14'>
            <h2 className='text-3xl font-bold text-slate-950'>
              Related employee reporting resources
            </h2>
            ...
            <div className='mt-6 grid gap-4 sm:grid-cols-2'>
              ...
              >
                ...
                <p className='mt-2 text-sm leading-6 text-slate-600'>
                  Use a reusable format for daily employee reports.
                </p>
              </Link>
              ...
              >
                ...
                <p className='mt-2 text-sm leading-6 text-slate-600'>
                  Prepare a clear daily management update.
                </p>
              </Link>
              ...
              >
                ...
                <p className='mt-2 text-sm leading-6 text-slate-600'>
                  Summarize work, blockers and next-day priorities.
                </p>
              </Link>
              ...
              >
                ...
                <p className='mt-2 text-sm leading-6 text-slate-600'>
                  Create and export an employee daily report.
                </p>
              </Link>
            </div>
          </section>
