          ...
          <section className='mt-14'>
            ...
            <div className='mt-6 grid gap-4 sm:grid-cols-2'>
              ...
              >
                ...
                <p className='mt-2 text-sm leading-6 text-slate-600'>
                  Learn the complete progress report structure.
                </p>
              </Link>
              ...
              >
                ...
                <p className='mt-2 text-sm leading-6 text-slate-600'>
                  Learn how to summarize overall project health and status.
                </p>
              </Link>
              ...
              >
                ...
                <p className='mt-2 text-sm leading-6 text-slate-600'>
                  Prepare a shorter daily management update.
                </p>
              </Link>
              ...
              >
                ...
                <p className='mt-2 text-sm leading-6 text-slate-600'>
                  Create and export a weekly progress report.
                </p>
              </Link>
            </div>
          </section>
