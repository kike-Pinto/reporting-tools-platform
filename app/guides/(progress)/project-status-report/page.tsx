    ...
    <main className='min-h-screen bg-slate-50 text-slate-900'>
      ...
      <article className='mx-auto max-w-4xl px-6 py-16 sm:py-20'>
        <div className='rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-12'>
          ...
          <section className='mt-14'>
            <h2 className='text-3xl font-bold text-slate-950'>
              Related project reporting resources
            </h2>
            ...
            <div className='mt-6 grid gap-4 sm:grid-cols-2'>
              ...
              >
                ...
                <p className='mt-2 text-sm leading-6 text-slate-600'>
                  Learn how to report weekly progress and schedule variance.
                </p>
              </Link>
              ...
              >
                ...
                <p className='mt-2 text-sm leading-6 text-slate-600'>
                  Learn the standard project progress report structure.
                </p>
              </Link>
              ...
              >
                ...
                <p className='mt-2 text-sm leading-6 text-slate-600'>
                  Learn how to document daily site activities and delays.
                </p>
              </Link>
              ...
              >
                ...
                <p className='mt-2 text-sm leading-6 text-slate-600'>
                  Create and export a project status report.
                </p>
              </Link>
            </div>
          </section>
